                                ...
                                <div class="flex flex-wrap items-center justify-between">
                                    {#each suggestionData.keywords.strength_path as keyword, i}
                                        <div class="flex flex-1 items-center mb-2 mr-1">
                                            <span class="bg-teal-600/90 bg-opacity-60 tracking-[0.2em] px-4 py-1 rounded-md text-sm font-medium text-white shadow-sm [writing-mode:vertical-lr] sm:[writing-mode:horizontal-tb]">{keyword}</span>
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap items-center">
                                    {#each suggestionData.keywords.weakness_path as keyword, i}
                                        <div class="flex flex-1 items-center mb-2 mr-1">
                                            <span class="bg-blue-600 bg-opacity-60 tracking-[0.2em] px-4 py-1 rounded-md text-sm font-medium text-white shadow-sm [writing-mode:vertical-lr] sm:[writing-mode:horizontal-tb]">{keyword}</span>
            ...
            <div class="mb-6">
                ...
                <div class="flex flex-wrap gap-3 grid grid-cols-2">
                    <button
                        ...
                        class={`px-5 cursor-pointer py-3 rounded-lg font-medium transition-all duration-300 flex items-center ${
                    ...
                    <button
                        ...
                        class={`px-5 py-3 cursor-pointer rounded-lg font-medium transition-all duration-300 flex items-center ${
